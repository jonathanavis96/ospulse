 ...
 * touched.
 */
public class PhatWangPanel extends PluginPanel implements SessionListener
{
	 ...
	 */
	public PhatWangPanel(PhatWangConfig config)
	{
		super(false);
	...
	private JPanel buildHeader()
	{
		...
		JLabel title = new JLabel("Phat Wang");
	...
	{
		private final PhatWangPanel owner;
		private final JPanel empty;
		private final JPanel content;
		private Component current;

		private CardHolder(PhatWangPanel owner, JPanel empty, JPanel content)
		{
			this.owner = owner;
			this.empty = empty;
