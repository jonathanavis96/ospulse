...
import com.phatwang.integration.SessionTracker;
import com.phatwang.sync.DashboardSyncService;
import com.phatwang.ui.PhatWangPanel;
 ...
 * the result in {@link PhatWangPanel}, and — only when the user opts in — hands
...
public class PhatWangPlugin extends Plugin
{
	...
	protected void startUp()
	{
		...
		panel = new PhatWangPanel(config);
		...
		log.debug("Phat Wang plugin started");
	}
	...
	protected void shutDown()
	{
		...
		log.debug("Phat Wang plugin stopped");
	}
