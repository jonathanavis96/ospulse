...
@ConfigGroup(PhatWangConfig.GROUP)
public interface PhatWangConfig extends Config
{
	String GROUP = "phatwang";
	...
	@ConfigItem(
		keyName = "syncUrl",
		name = "Sync URL",
		description = "Full HTTPS URL of your companion dashboard's ingest endpoint. "
