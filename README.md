...
- 🧪 **A "don't forget" reminder under prayers and potions.** Curated per target — antivenom for venomous bosses, recoils and rings of suffering for Zulrah, antifire and a dragonfire shield for dragons, and so on — so the consumables that don't show up in a gear slot stop being the thing you notice on the boat over. It also appends to the bank tag, so the reminder items are highlighted alongside your gear.
